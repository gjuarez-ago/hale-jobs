...
@Component({
  selector: 'app-admin-notfications',
  templateUrl: './admin-notfications.component.html',
  styleUrls: ['./admin-notfications.component.css']
})
export class AdminNotficationsComponent implements OnInit {
