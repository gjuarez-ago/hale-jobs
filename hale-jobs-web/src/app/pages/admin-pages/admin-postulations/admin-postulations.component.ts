...
@Component({
  selector: 'app-admin-postulations',
  templateUrl: './admin-postulations.component.html',
  styleUrls: ['./admin-postulations.component.css']
})
export class AdminPostulationsComponent implements OnInit {
