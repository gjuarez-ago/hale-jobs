...
@Component({
  selector: 'app-admin-postulations-i',
  templateUrl: './admin-postulations-i.component.html',
  styleUrls: ['./admin-postulations-i.component.css']
})
export class AdminPostulationsIComponent implements OnInit {
