...
@Component({
  selector: 'app-admin-type-of-job',
  templateUrl: './admin-type-of-job.component.html',
  styleUrls: ['./admin-type-of-job.component.css']
})
export class AdminTypeOfJobComponent implements OnInit {
