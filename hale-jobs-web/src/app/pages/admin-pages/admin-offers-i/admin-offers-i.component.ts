...
@Component({
  selector: 'app-admin-offers-i',
  templateUrl: './admin-offers-i.component.html',
  styleUrls: ['./admin-offers-i.component.css']
})
export class AdminOffersIComponent implements OnInit {
