...
@Component({
  selector: 'app-admin-opinions-by-company',
  templateUrl: './admin-opinions-by-company.component.html',
  styleUrls: ['./admin-opinions-by-company.component.css']
})
export class AdminOpinionsByCompanyComponent implements OnInit {
