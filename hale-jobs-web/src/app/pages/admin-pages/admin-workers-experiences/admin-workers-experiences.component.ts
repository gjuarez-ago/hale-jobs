...
@Component({
  selector: 'app-admin-workers-experiences',
  templateUrl: './admin-workers-experiences.component.html',
  styleUrls: ['./admin-workers-experiences.component.css']
})
export class AdminWorkersExperiencesComponent implements OnInit {
