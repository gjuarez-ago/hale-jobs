...
export class SearchOffersComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    .subscribe((res : any)=>{
     ...
     if(this.current >= 1) {
      ...
      res.subcategory ? res.subcategory = res.subcategory : res.subcategory = "";
      res.urgency ? res.urgency = res.urgency : res.urgency = "";
      res.levelStudy ? res.levelStudy = res.levelStudy : res.levelStudy = "";
      res.workPlace ? res.workPlace = res.workPlace : res.workPlace = "";
      res.typeOfJob ? res.typeOfJob = res.typeOfJob : res.typeOfJob = "";
      res.rangeAmount ? res.rangeAmount = res.rangeAmount : res.rangeAmount = "";
  ...
  public getListPaginate() : void {
    ...
    this.subscriptions.push(
      this.offerService.searchOffersWEB(
        {
